...
/**
 * https://github.com/GoodBoyDigital/pixi.js/blob/master/src/pixi/utils/EventTarget.js
 * Kudos to mrdoob and pixi.js devs!
 */
 ...
 * @example
 *      function MyEmitter() {
 *          LUDUMPAD.EventTarget.call(this); //mixes in event target stuff
 *      }
 *
 *      var em = new MyEmitter();
 *      em.emit({ type: 'eventName', data: 'some data' });
 */
LUDUMPAD.EventTarget = function () {
